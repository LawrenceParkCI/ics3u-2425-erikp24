...
public class NFOutput {
	...
	public static void main(String[] args) {
		...
		//How can you change how your value is displayed? A: by formatting the value using number.format
		
		//What other formats does NumberFormat offer? A: Currency, Percentage, Date, Decimal, etc.
